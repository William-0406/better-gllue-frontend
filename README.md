...
- **联系方式精确匹配**优先（手机 / 邮箱），其次档案链接，再按「姓名 + 经历/学校」分级比对；
...
<p align="center">
  <img src="docs/assets/enrich.svg" alt="简历自动补全：进度可视 + 只补不覆盖" width="900"/>
</p>
...
谷露页面内提供更清爽的只读视图，快速浏览人才、公司、职位和本周业务进展。新增、编辑、推荐等写操作仍回谷露原页面完成。
